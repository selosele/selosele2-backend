...
export const NotificationCodes = {
  ...
  GUESTBOOK_REPLY: { id: 'D02004', prefix: 'D02', val: '004', nm: '방명록 댓글', desc: '알림 유형', useYn: 'Y' },
  SATISFACTION:    { id: 'D02005', prefix: 'D02', val: '005', nm: '만족도조사', desc: '알림 유형', useYn: 'Y' },
  ETC:             { id: 'D02006', prefix: 'D02', val: '006', nm: '기타', desc: '알림 유형', useYn: 'N' },
};