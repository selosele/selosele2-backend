...
export class GuestbookEntity extends BaseEntity {
  ...
  @Column({ comment: '방명록 작성자' })
  @ApiProperty({ description: '방명록 작성자' })
  author?: string;

  @Column({ comment: '방명록 작성자 비밀번호' })
  @ApiProperty({ description: '방명록 작성자 비밀번호' })
  authorPw?: string;

  @Column({ comment: '방명록 작성자 IP', select: false })
  @ApiProperty({ description: '방명록 작성자 IP' })
  ip?: string;

  @Column({ comment: '방명록 내용' })
  ...
  @CreateDateColumn({ comment: '방명록 등록일시' })
  @ApiProperty({ description: '방명록 등록일시' })
  regDate?: Date;

  @UpdateDateColumn({ comment: '방명록 수정일시' })
