...
export class IndexSearchEntity extends BaseEntity {
  ...
  @Column({ comment: '색인 데이터 카테고리 정보' })
  @ApiProperty({ description: '색인 데이터 카테고리 정보' })
  category?: string;

  @Column({ comment: '색인 데이터 태그 정보' })
  ...
  @CreateDateColumn({ comment: '색인 데이터 등록일시' })
